...
class Sailboat < Formula
  ...
  url "https://files.pythonhosted.org/packages/3a/ae/08650d566196de2d8c80ba7657692d8ba77bc27665ea98d34f48a2e26675/sailboat-0.26.2.tar.gz" # These lines must be configured during release, not build.
